...
export const siteConfig: SiteConfig = {
	title: "Starfall",
	subtitle: "看看流星///",
	siteURL: "https://blog.usisy.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		homeText: {
			...
			typewriter: {
				...
				speed: 48, // 打字速度（毫秒）
				deleteSpeed: 48, // 删除速度（毫秒）
				pauseTime: 2048, // 完全显示后的暂停时间（毫秒）
			},
		},
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/qiMengStars",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "qiMengStars/QMStarsBlog",
		repoId: "R_kgDOSGw24Q",
		category: "Announcements",
		categoryId: "DIC_kwDOSGw24c4C7Wao",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
